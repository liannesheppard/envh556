...
For later use, we need to convert the grid to geodata.  Also, the full grid isn't working, so we use a subset.  TODO:  (Optional!) Figure out if we can make this work by dividing the prediction step into two pieces.

...
# should either append the grouping variable to the output dataset for cases when it isn't part of the input dataset, or require that it is a variable in the dataset

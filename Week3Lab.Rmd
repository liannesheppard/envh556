...
2.	Using the terminology given in lecture, briefly discuss the fall season model results.  Include in your discussion an interpretation for at least two terms in the fall season model.   
3.	Focusing on the common models in Table 4 of Mercer et al, think about how to use the data from all seasons to get season-specific parameter estimates.   What terms do you need to incorporate the interactions?   

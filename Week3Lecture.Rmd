...
This is a companion document to the Week 3 lecture.  Each slide with R code is represented in this document.

Note to students:  There are some details that should be cleaned up.
...
#season is the same variable as seasonfac, not as a factor and coded the same 1,2,3. Verify this:  
...
TODO:  NOTE something is wrong here because the correlation is too high.  Should be about .85 to get the estimated R2 of .7252.  NEED to check why.

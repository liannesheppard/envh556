...
# Hmisc:  describe
# lme4
pacman::p_load(tidyverse, knitr, dplyr, modelr, Hmisc, parallel)  
```
...
system.time(result_pure_sp <- lapply(1:1000, function(x) me_pure()))

# Multi-core processing - mclapply() does not work in Windows
# if (.Platform$OS.type != "windows") {
#     system.time(result_pure_mp <- mclapply(1:1000, function(x) me_pure(), 
#                                            mc.cores = 8, 
#                                            mc.set.seed = TRUE,
#                                            mc.preschedule = TRUE))
#}
